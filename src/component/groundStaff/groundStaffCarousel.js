...
const GroundStaffCarouselWrapper = function () {
  const src1 = "/carousel/airbus_img_1.webp";
  const src2 = "/carousel/img_3.png";
  return (
    <Carousel className='container'>
      <Carousel.Item>
        <Image src={src1} width={200} height={200} alt="Car Image 1" className="img2" />
        <Carousel.Caption>
      ...
      <Carousel.Item>
      <Image src={src2} width={200} height={200} alt="Car Image 1" className="img2" />
        <Carousel.Caption>
...
export default GroundStaffCarouselWrapper;