import GroundStaffTableRepairHistory from "./groundStaffTableMaintenanceHistory";


const repairHistoryDummyData = [
  {
    "aircraftId": "AIR1", 
...
const GroundStaffRepairHistoryDetails = function({setChoiceUtility}) {
  ...
  return (
    <>
      <GroundStaffTableRepairHistory repairHistory={repairHistoryDummyData} setChoiceUtility={setChoiceUtility}/>
    </>
  );
};

export default GroundStaffRepairHistoryDetails;
